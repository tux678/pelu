...
public class ProfesionalGui extends UsuarioGui {
	
	private static final int BTN_GUARDAR = 1;
	private ProfesionalGui() {
		super();
	...
	private void addProfesional() throws ClassNotFoundException, SQLException {
		...
		new Profesional(getTxtUsuario().getText(), "jara", Rol.Profesional, getTxtNombre().getText(), getTxtApellido().getText(), 
